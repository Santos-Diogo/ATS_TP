...
public class Fatura implements Serializable {
    ...
    public double getPrecoTransporte() {
        if (this.compra) {
            ...
            throw new UnsupportedOperationException("Não é uma compra, então não há custo de transporte.");
        }
    }
    ...
    public double getTaxaVintage() {
        if (!this.compra) {
            ...
            throw new UnsupportedOperationException("Não é uma venda, então não há taxa Vintage.");
        }
    }
